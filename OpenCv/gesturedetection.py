...
while True:
    ...
    if len(landmark_list)!=0:
        ...
        cv2.putText(image,"Intensity: {} %".format(int(intensity)),(40,450),cv2.FONT_HERSHEY_DUPLEX,1,(0,255,0),3)
    current_time = time.time()
    fps = 1/(current_time-previous_time)
    previous_time = current_time
    cv2.putText(image,"FPS: {}".format(int(fps)),(40,70),cv2.FONT_HERSHEY_DUPLEX,1,(0,255,0),3)
